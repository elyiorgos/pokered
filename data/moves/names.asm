MoveNames::
	...
	li "OŠTAR VETAR"   ; RAZOR WIND -> prirodno i sažeto
	li "PLES MAČEVA"   ; SWORDS DANCE -> pun prirodan prevod
	li "SECI"          ; CUT -> komanda/move stil
	li "UDAR VETRA"    ; GUST -> udar vetra
	li "KRILNI UDAR"   ; WING ATTACK -> prirodan prevod
	li "VIHOR"         ; WHIRLWIND -> kraće i idiomatski
	li "LET"           ; FLY -> najprirodnije
	li "STEGA"         ; BIND -> prirodan battle termin
	...
	li "DV. OŠTRICA"   ; DOUBLE-EDGE -> skraćeno, period zbog limita
	li "BIČ REPA"      ; TAIL WHIP -> prirodno i kratko
	li "OTR. ŽAOKA"    ; POISON STING -> skraćeno, period zbog limita
	li "DVOIGLA"       ; TWINEEDLE -> prirodna kovanica
	li "IGLORAKETA"    ; PIN MISSILE -> prirodna fan-lokalizacija
	li "PREK POGLED"   ; LEER -> efekat važniji od doslovnosti
	li "UJED"          ; BITE -> najprirodnije
	li "REŽANJE"       ; GROWL -> prirodan prevod
	li "RIK"           ; ROAR -> kraći i snažniji od "urlik"
	li "PESMA"         ; SING -> prirodan prevod
	li "SUPERZVUK"     ; SUPERSONIC -> direktan ali prirodan prevod
	li "ZVUČNI BUM"    ; SONICBOOM -> zvučni bum
	li "BLOKADA"       ; DISABLE -> prirodan efekat
	li "KISELINA"      ; ACID -> direktan prevod
	li "ŽAR"           ; EMBER -> prirodnije od dužih opcija
	li "BACAČ PLAM."   ; FLAMETHROWER -> skraćeno, period zbog limita
	li "IZMAGLICA"     ; MIST -> prirodniji pun prevod
	li "MLAZ VODE"     ; WATER GUN -> prirodno i kratko
	li "HIDROPUMPA"    ; HYDRO PUMP -> prirodna složenica
	li "SURF"          ; SURF -> ostavljeno zbog prepoznatljivosti
	...
	li "SEIZ. BAC."    ; SEISMIC TOSS -> skraćeno, period zbog limita
	li "SNAGA"         ; STRENGTH -> prirodan prevod
	li "UPIJANJE"      ; ABSORB -> prirodan imenicki oblik
	li "MEGA UP."      ; MEGA DRAIN -> skraćeno "upijanje"
	...
	li "GROM"          ; THUNDER -> najkraće i najjače
	li "BACI KAMEN"    ; ROCK THROW -> prirodan prevod
	li "ZEMLJOTRES"    ; EARTHQUAKE -> direktan prevod
	li "RASED"         ; FISSURE -> prirodno skraćenje
	li "KOPAJ"         ; DIG -> prirodno
	li "OTROV"         ; TOXIC -> efekat važniji od forme
	li "ZBUNJENOST"    ; CONFUSION -> pun prirodan prevod
	li "PSIHA"         ; PSYCHIC -> kraće i prirodno
	li "HIPNOZA"       ; HYPNOSIS -> direktan prevod
	li "MEDITACIJA"    ; MEDITATE -> prirodan prevod
	li "OKRETNOST"     ; AGILITY -> prirodan prevod
	li "BRZI NAPAD"    ; QUICK ATTACK -> prirodno
	li "BES"           ; RAGE -> najkraće i prirodno
	li "TELEPORT"      ; TELEPORT -> direktan prevod
	li "NOĆNA SENKA"   ; NIGHT SHADE -> prirodan prevod
	li "MIMIKRIJA"     ; MIMIC -> prirodnije od "mimik"
	li "KREŠTANJE"     ; SCREECH -> prirodan prevod
	li "DUPLI TIM"     ; DOUBLE TEAM -> gejmerski i kratko
	li "OPORAVAK"      ; RECOVER -> prirodan prevod
	...
	li "LOBANJA"       ; SKULL BASH -> sažeto na motiv
	li "ŠILJOTOP"      ; SPIKE CANNON -> fan-lokalizacija
	li "STEZANJE"      ; CONSTRICT -> prirodan prevod
	li "AMNEZIJA"      ; AMNESIA -> direktan prevod
	li "KINEZA"        ; KINESIS -> sažeto i prepoznatljivo
	li "MEKO KUVANO"   ; SOFTBOILED -> prirodan prevod
	li "VISOKI ŠUT"    ; HI JUMP KICK -> sažeto
	li "UKOČEN POG."   ; GLARE -> fokus na efektu, skraćeno
	li "JEDAČ SNOVA"   ; DREAM EATER -> prirodan prevod
	li "OTR. GAS"      ; POISON GAS -> skraćeno, period zbog limita
	...
	li "SPORA"         ; SPORE -> prirodan prevod
	li "BLESAK"        ; FLASH -> prirodan prevod
	li "PSI-TALAS"     ; PSYWAVE -> prirodan prevod
	li "PLJUS"         ; SPLASH -> najprirodnije
	li "KISEL. OKL."   ; ACID ARMOR -> skraćeno, period zbog limita
	li "ČEKIĆ RAKA"    ; CRABHAMMER -> prirodna fan-lokalizacija
	li "EKSPLOZIJA"    ; EXPLOSION -> direktan prevod
	li "KANÐE"         ; FURY SWIPES -> sažeto na prirodan srpski
	li "KOSTERANG"     ; BONEMERANG -> od kosta i bumerang
	li "ODMOR"         ; REST -> prirodan prevod
	li "ODRON"         ; ROCK SLIDE -> efekat važniji od doslovnosti
